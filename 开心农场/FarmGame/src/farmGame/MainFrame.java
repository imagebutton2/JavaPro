...
public class MainFrame extends JFrame implements MouseListener,Runnable{
	...
	public MainFrame(){
		...
		Image bk = Toolkit.getDefaultToolkit().getImage("F:/Java/Java Project/开心农场/素材/farmBackground.png");
		...
		button_1.setRolloverIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/播种1.png"));//移动到图标上显示的图片
		button_1.setBorderPainted(false);
		button_1.setContentAreaFilled(false);
		button_1.setIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/播种.png"));//正常显示图片
		button_1.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				String message = farm.seed(crop, "F:/Java/Java Project/开心农场/素材/seed.png");
				if(!message.equals("")){
		...
		button_2.setRolloverIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/生长1.png"));
		button_2.setIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/生长.png"));
		button_2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String message = farm.grow(crop, "F:/Java/Java Project/开心农场/素材/grow.png");
				if(!message.equals("")){
					JOptionPane.showMessageDialog(null, message);
				}
			}
		...
		button_3.setRolloverIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/开花1.png"));
		button_3.setIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/开花.png"));
		button_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String message = farm.bloom(crop, "F:/Java/Java Project/开心农场/素材/bloom.png");
				if(!message.equals("")){
					JOptionPane.showMessageDialog(null, message);
				}
			}
		...
		button_4.setRolloverIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/结果1.png"));
		button_4.setIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/结果.png"));
		button_4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String message = farm.fruit(crop,"F:/Java/Java Project/开心农场/素材/fruit.png");
				if(!message.equals("")){
					JOptionPane.showMessageDialog(null, message);
				}
			}
		...
		button_5.setRolloverIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/收获1.png"));
		button_5.setIcon(new ImageIcon("F:/Java/Java Project/开心农场/素材/收获.png"));
		...
		try{
			...
			for(int i=0;i<9;i++){
				...
				case 1:
					...
					crops[i].setIcon("F:/Java/Java Project/开心农场/素材/seed.png");
					break;
				case 2:
					farms[i].state = 2;
					farms[i].lastTime = new Date(lastTime.getTime()+temp);
					crops[i].setIcon("F:/Java/Java Project/开心农场/素材/grow.png");
					break;
				case 3:
					farms[i].state = 3;
					farms[i].lastTime = new Date(lastTime.getTime()+temp);
					crops[i].setIcon("F:/Java/Java Project/开心农场/素材/bloom.png");
					break;
				case 4:
					farms[i].state = 4;
					farms[i].lastTime = new Date(lastTime.getTime()+temp);
					crops[i].setIcon("F:/Java/Java Project/开心农场/素材/fruit.png");
					break;
				}
